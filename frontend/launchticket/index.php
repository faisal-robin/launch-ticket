...
<section class="abh-slider-area overlay">
    <div class="abh-slide owl-carousel">
        <div class="slider-container">
            <div class="single-slider zoom" style="background-image: url(./assets/img/launch-ticket-slider1.jpg);">
            </div>
        </div>
        <div class="slider-container">
            <div class="single-slider zoom" style="background-image: url(./assets/img/launch-ticket-slider2.jpg);">
            </div>
        </div>
...
<!-- About Page Start -->
<section class="abh-about-page" style="background-image: url(./assets/img/wave 4.png);">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="about-page-right">
                    <span id="overlap1"><img class="img-fluid" src="assets/img/launch.png" alt="about page" /></span>
                </div>
            </div>
            <!-- <div class="col-lg-12">
                <div class="arnx5">
                    <span id="overlap1"><img class="img-fluid" src="assets/img/wave 4.png" alt="about page" /></span>
                </div>
            </div> -->
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="shape-image text-center">
                    <!-- <img class="img-fluid" src="assets/img/bann-img.png" alt=""> -->
                    <div class="grun-img shape-3">
                        <img class="img-fluid" src="assets/img/spin-bg.png" alt="">
                    </div>
                    <div class="video-btn">
...
<section class="abh-destination-area section_70" style="background-image: url('./assets/img/city7.png');">
...
<!-- Reviews Area Start -->
<section class="abh-reviews-area section_70" style="background-image: url(./assets/img/banner-testimonial.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
