...
//        $this->middleware('auth');
    ...
    public function index() {
        ...
        $data['trending_products'] = TrendingProduct::limit(4)->get();
        $data['special_products'] = SpecialProduct::limit(6)->get();
        $data['home_category'] = Category::where('home_page_status', 1)->get();
//        echo '<pre>'; 
