    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-info btn-sm" href="{{url('admin/categories/create')}}"><i class="fas fa-plus-circle"></i> Add New Category</a>
            </div>
            @endif
        </div>
        <!-- /.card-header -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('admin/categories/'.$row->id.'/edit')}}" style="margin-right: 5px" class="btn btn-primary btn-sm float-left view_modal">
                                Edit
                            </a> 
                            @endif
